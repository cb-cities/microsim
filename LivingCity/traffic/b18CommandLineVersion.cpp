...
//  RoutingKit::ContractionHierarchy ch = RoutingKit::ContractionHierarchy::build(
...
//  RoutingKit::CustomizableContractionHierarchy cch(ch.order, network->heads(),
//                                                   network->tails());
...
//  auto diff2 = t4 - t3;
//  std::cout << chrono::duration<double, milli>(diff2).count() << " ms" << endl;
//  routingCH.stopAndEndBenchmark();
//
...
//  auto diff3 = t6 - t5;
//  std::cout << chrono::duration<double, milli>(diff3).count() << " ms" << endl;
